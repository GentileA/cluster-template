...
CUSTOM_USER=ag781693
CUSTOM_SSHDIR=/users/ag781693/.ssh
...
sudo touch /users/ag781693/.ssh/.config
sudo echo "StrictHostKeyChecking no" | sudo tee -append /users/ag781693/.ssh/.config

#su ag781693 -c 'echo "StrictHostKeyChecking no" > ${CUSTOM_SSHDIR}/config'
